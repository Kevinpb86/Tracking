...
<body class="h-screen overflow-hidden relative">
    ...
    <div class="fixed inset-0 bg-cover bg-center bg-no-repeat"
        style="background-image: url('{{ asset('images/bglogin2.jpeg') }}');"></div>
    ...
    <div class="relative h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 -mt-4">
            ...
            <div
                ...
                @if (session('status'))
                    <div
                        class="mb-6 rounded-xl border border-emerald-200 bg-emerald-50/90 px-4 py-3 text-sm font-medium text-emerald-700 shadow-sm">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                @if ($errors->any())
                    <div
                        class="mb-6 rounded-xl border border-red-200 bg-red-50/90 px-4 py-3 text-sm font-medium text-red-700 shadow-sm">
                ...
                <form class="space-y-6" method="POST" action="{{ route('password.forgot.send') }}">
                    ...
                    <div class="text-center">
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 transition duration-200">
