                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('password.forgot') }}"
                                class="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 transition duration-200">
                                Forgot password?
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="{{ route('register') }}"
                                class="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 transition duration-200 cursor-pointer">
                                Sign up here
                            </a>
                        </p>
                    </div>
