    ...
    <div class="relative min-h-screen overflow-x-hidden">
        ...
        <main class="relative flex min-h-screen flex-col pt-32 sm:pt-36 lg:pt-40">
            ...
            <header class="px-8 pt-8 sm:px-12 lg:px-24">
                <div
                    class="mx-auto rounded-3xl bg-gradient-to-r from-blue-600 to-blue-700 py-10 px-8 sm:px-12 shadow-2xl relative overflow-hidden group">
                    {{-- Decorative Elements --}}
                    <div
                    ...
                    <div class="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                        <div class="max-w-2xl space-y-4">
                            ...
                            <p class="text-base text-blue-50/80 leading-relaxed max-w-xl">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex flex-col items-end">
                                        <span
                                            ...
                                            Records</span>
                                        <span
                                            class="text-3xl font-black text-slate-900">{{ number_format($pos1_count) }}</span>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="flex items-center gap-3 py-4 border-y border-slate-50">
                                    <div class="flex-1">
                                        <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">
                                            Today's Traffic</p>
                                        <p class="text-xl font-bold text-blue-600">+{{ $pos1_today }} <span
                            ...
                            <div class="relative z-10 space-y-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex flex-col items-end">
                                        <span
                                            ...
                                            Checks</span>
                                        <span
                                            class="text-3xl font-black text-slate-900">{{ number_format($pos2_count) }}</span>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="flex items-center gap-3 py-4 border-y border-slate-50">
                                    <div class="flex-1">
                                        <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">
                                            Today's Check</p>
                                        <p class="text-xl font-bold text-emerald-600">{{ $pos2_today }} <span
                            ...
                            <div class="relative z-10 space-y-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex flex-col items-end">
                                        <span
                                            ...
                                            Items</span>
                                        <span
                                            class="text-3xl font-black text-slate-900">{{ number_format($scm_count) }}</span>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="flex items-center gap-3 py-4 border-y border-slate-50">
                                    <div class="flex-1">
                                        <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">
                                            Input Today</p>
                                        <p class="text-xl font-bold text-purple-600">{{ $scm_today }} <span
