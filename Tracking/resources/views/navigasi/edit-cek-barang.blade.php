...
<head>
    ...
    <title>Edit Form Distribusi - POS 2</title>
            ...
            <main class="relative flex min-h-screen flex-col pt-32 sm:pt-36 lg:pt-40">
                ...
                <section class="relative mx-auto w-full flex-1 px-4 py-8 sm:px-6 lg:px-8">
                        ...
                        <div class="relative px-6 pt-10 pb-6 text-center sm:px-12">
                            <div class="relative z-10 flex flex-col items-center space-y-4">
                                <div
                                    ...
                                    <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-800">Edit
                                        Form
                                        Distribusi</span>
                                </div>
                                <h1
                                    class="text-4xl font-extrabold tracking-tight text-emerald-600 sm:text-5xl lg:text-6xl text-center">
                                    Edit Formulir Distribusi</h1>
                                <p class="max-w-2xl text-lg font-medium text-slate-600 leading-relaxed">
                                    Update data pemeriksaan barang distribusi. Pastikan semua perubahan informasi yang
                                    diisi akurat untuk memastikan kelancaran proses distribusi barang.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="max-w-5xl mx-auto w-full pb-20">
                        <form action="{{ route('cek-barang.update', $cekBarang->id) }}" method="POST" class="space-y-6">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" id="waktu" name="waktu" required
                                                class="form-input w-full rounded-lg border-2 border-slate-200 px-4 py-3 text-slate-700 focus:border-emerald-500 focus:outline-none"
                                                value="{{ substr($cekBarang->waktu, 0, 5) }}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama_pemeriksa" name="nama_pemeriksa" required
                                                ...
                                                class="form-input w-full rounded-lg border-2 border-slate-200 px-4 py-3 text-slate-700 focus:border-emerald-500 focus:outline-none"
                                                value="{{ $cekBarang->nama_pemeriksa }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama_pengemudi" name="nama_pengemudi" required
                                                placeholder="Nama Lengkap"
                                                class="form-input w-full rounded-lg border-2 border-slate-200 px-4 py-3 text-slate-700 focus:border-emerald-500 focus:outline-none"
                                                value="{{ $cekBarang->nama_pengemudi }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="nomor_do"
                                                class="form-label block text-sm font-semibold text-slate-700 mb-2">Nomor
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div class="form-group">
                                            ...
                                            <select id="kondisi_kemasan" name="kondisi_kemasan" required
                                                class="form-input w-full rounded-lg border-2 border-slate-200 px-4 py-3 text-slate-700 focus:border-emerald-500 focus:outline-none">@php $kondisi_kemasan_options = ["Baik", "Rusak", "Basah"]; @endphp
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="lokasi_kebocoran" name="lokasi_kebocoran"
                                                ...
                                                class="form-input w-full rounded-lg border-2 border-slate-200 px-4 py-3 text-slate-700 focus:border-emerald-500 focus:outline-none"
                                                value="{{ $cekBarang->lokasi_kebocoran }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="catatan" name="catatan" rows="3"
                                                ...
                                                class="form-input w-full rounded-lg border-2 border-slate-200 px-4 py-3 text-slate-700 focus:border-emerald-500 focus:outline-none">{{ $cekBarang->catatan }}</textarea>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="flex items-center justify-between gap-4 pt-4">
                                <a href="{{ route('cek-barang.index') }}"
                                    class="submit-btn inline-flex items-center gap-2 px-8 py-3 rounded-xl font-bold shadow-lg shadow-emerald-500/20">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
