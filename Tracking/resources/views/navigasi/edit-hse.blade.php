        ...
        <main class="relative flex min-h-screen flex-col pt-32 sm:pt-36 lg:pt-40">
            ...
            <section class="relative mx-auto w-full flex-1 px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div class="mx-auto w-full max-w-5xl px-4 py-8">
                    ...
                    {{-- Form Content --}}
                    <form action="{{ route('hse.update', $hse->id) }}" method="POST" class="space-y-10 max-w-5xl mx-auto"
                        id="hseForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="p-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="tanggal" name="tanggal" value="{{ old('tanggal', $hse->tanggal) }}" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" id="waktu" name="waktu" value="{{ old('waktu', $hse->waktu) }}" required
                                            class="form-input w-full rounded-xl border-2 border-slate-400 bg-slate-50 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500/20">
                                    </div>
                                    ...
                                    <div class="form-group md:col-span-2">
                                        ...
                                        <input type="text" id="nama_petugas" name="nama_petugas"
                                            value="{{ old('nama_petugas', $hse->nama_petugas) }}" required
                                            class="form-input w-full rounded-xl border-2 border-slate-400 bg-slate-50 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500/20">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nomor_polisi" name="nomor_polisi"
                                            value="{{ old('nomor_polisi', $hse->nomor_polisi) }}"
                                            class="form-input w-full rounded-xl border-2 border-slate-400 bg-slate-50 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500/20"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_driver" name="nama_driver"
                                            value="{{ old('nama_driver', $hse->nama_driver) }}"
                                            class="form-input w-full rounded-xl border-2 border-slate-400 bg-slate-50 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500/20"
                                    ...
                                    <div class="form-group md:col-span-2">
                                        ...
                                        <input type="text" id="perusahaan" name="perusahaan"
                                            value="{{ old('perusahaan', $hse->perusahaan) }}"
                                            class="form-input w-full rounded-xl border-2 border-slate-400 bg-slate-50 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500/20"
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="catatan_safety" name="catatan_safety" rows="3"
                                            class="form-input w-full rounded-xl border-2 border-slate-400 bg-slate-50 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500/20"
                                            placeholder="Tuliskan temuan atau catatan keselamatan...">{{ old('catatan_safety', $hse->catatan_safety) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="tindak_lanjut" name="tindak_lanjut" rows="3"
                                            class="form-input w-full rounded-xl border-2 border-slate-400 bg-slate-50 px-4 py-3 text-slate-900 focus:border-emerald-500 focus:ring-emerald-500/20"
                                            placeholder="Rencana tindak lanjut jika ada temuan...">{{ old('tindak_lanjut', $hse->tindak_lanjut) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-3 gap-3">
                                            <label class="cursor-pointer relative group">
                                                <input type="radio" name="status" value="Lolos" {{ old('status', $hse->status) == 'Lolos' ? 'checked' : '' }} class="peer sr-only">
                                            ...
                                            <label class="cursor-pointer relative group">
                                                <input type="radio" name="status" value="Perbaikan" {{ old('status', $hse->status) == 'Perbaikan' ? 'checked' : '' }} class="peer sr-only">
                                            ...
                                            <label class="cursor-pointer relative group">
                                                <input type="radio" name="status" value="Ditolak" {{ old('status', $hse->status) == 'Ditolak' ? 'checked' : '' }} class="peer sr-only">
