                            ...
                            <div class="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-3 w-full max-w-2xl">
                                <div class="rounded-xl bg-white/10 p-2.5 border border-white/10 backdrop-blur-md">
                                    <p class="text-[9px] font-bold uppercase tracking-widest text-white/70">
                                        Queue Status</p>
                                    <p class="text-xs font-bold text-white">Active Management</p>
                                </div>
                                <div class="rounded-xl bg-white/10 p-2.5 border border-white/10 backdrop-blur-md">
                                    <p class="text-[9px] font-bold uppercase tracking-widest text-white/70">
                                        Daily Target</p>
                                    <p class="text-xs font-bold text-white">Fast Processing</p>
                                </div>
                                <div class="rounded-xl bg-white/10 p-2.5 border border-white/10 backdrop-blur-md">
                                    <p class="text-[9px] font-bold uppercase tracking-widest text-white/70">
                                        Priority</p>
                                    <p class="text-xs font-bold text-white">Operational Excellence</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="rounded-3xl bg-white p-8 shadow-sm border border-slate-100 h-fit sticky top-40">
                                ...
                                <ul class="space-y-4">
                                    <li class="flex gap-4">
                                        ...
                                        <p class="text-sm text-slate-600 leading-relaxed"><span
                                                class="font-bold text-slate-900">Validasi Identitas</span>: Periksa STNK
                                            dan KTP driver untuk memastikan data armada sesuai.</p>
                                    </li>
                                    <li class="flex gap-4">
                                        <div
                                            class="flex-shrink-0 h-6 w-6 rounded-full bg-slate-100 flex items-center justify-center text-[10px] font-bold text-slate-500">
                                            02</div>
                                        <p class="text-sm text-slate-600 leading-relaxed"><span
                                                class="font-bold text-slate-900">Input Data</span>: Masukkan Nopol dan
                                            Nama Driver dengan teliti ke dalam sistem.</p>
                                    </li>
                                    <li class="flex gap-4">
                                        <div
                                            class="flex-shrink-0 h-6 w-6 rounded-full bg-slate-100 flex items-center justify-center text-[10px] font-bold text-slate-500">
                                            03</div>
                                        <p class="text-sm text-slate-600 leading-relaxed"><span
                                                class="font-bold text-slate-900">Arahkan Gate</span>: Berikan instruksi
                                            tujuan Gate kepada driver sesuai jenis muatan.</p>
                                    </li>
                                </ul>
                                ...
                                <div class="mt-8 rounded-2xl bg-blue-50 p-4 border border-blue-100">
                                    ...
                                    <p class="text-xs text-blue-600 leading-relaxed">
                                        Pastikan driver mendapatkan nomor antrian fisik jika sistem manual masih
                                        ...
                                        <div class="grid grid-cols-1 gap-8">
                                            <div class="space-y-2">
                                                ...
                                                <select id="tujuan" name="tujuan" required
                                                    class="w-full rounded-2xl border-2 border-slate-100 bg-slate-50 py-4 px-6 font-bold text-slate-900 transition-all focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-blue-500/5 appearance-none">
                                                    <option value="" disabled selected>Pilih Gate / Area</option>
