    ...
    <div class="relative min-h-screen overflow-x-hidden">
        ...
        <aside id="sidebar"
            ...
            <div class="relative flex h-full flex-col gap-6 overflow-y-auto p-8">
                <div class="relative flex items-center gap-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                    <div
                        class="flex h-14 w-14 items-center justify-center rounded-lg border border-blue-100 bg-blue-50 p-1.5">
                        <img src="{{ asset('images/wgilogo.jpg') }}" alt="Logo PT. Wiraswasta Gemilang Indonesia"
                            class="h-full w-full rounded-xl object-contain">
                    </div>
                    <div class="space-y-1">
                        <p class="text-[11px] font-semibold uppercase tracking-[0.45em] text-blue-500">Tracking System
                        </p>
                        <p class="text-base font-semibold text-slate-900 leading-snug">PT. Wiraswasta Gemilang Indonesia
                        </p>
                    </div>
                </div>
                ...
                <div class="relative space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="rounded-full bg-blue-50 px-3 py-0.5 text-[10px] font-semibold uppercase tracking-[0.3em] text-blue-500">Live</span>
                    </div>
                    <nav class="flex flex-col gap-3 text-sm font-semibold text-slate-600">
                        <a href="{{ route('pos1.dashboard') }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 text-slate-400 transition duration-200 group-hover:text-slate-600"
                                viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd"
                        ...
                        <a href="#"
                            ...
                            <span class="flex items-center gap-3">
                                <span
                                    class="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-100 text-blue-600 transition duration-200 group-hover:bg-blue-500 group-hover:text-white">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 text-blue-400 transition duration-200 group-hover:text-blue-600"
                                viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M7.22 14.78a.75.75 0 0 1 0-1.06L10.94 10 7.22 6.28a.75.75 0 1 1 1.06-1.06l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0Z"
                                    clip-rule="evenodd" />
                        ...
                        <div class="space-y-1">
                            <button type="button" onclick="toggleHSEMenu()"
                                ...
                                <span class="flex items-center gap-3">
                                    <span
                                        class="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-500 text-white transition duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                            fill="currentColor">
                                            <path
                                ...
                                <svg id="hseToggleIcon" xmlns="http://www.w3.org/2000/svg"
                                    class="h-4 w-4 text-emerald-400 transition-transform rotate-180 group-hover:text-emerald-600"
                                    viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd"
                            ...
                            <div id="hseSubmenu" class="ml-8 space-y-1">
                                <a href="{{ route('hse.input') }}"
                                    ...
                                    <span class="flex items-center gap-3">
                                        <span
                                            class="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-500 transition duration-200 group-hover:bg-emerald-600">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-4 w-4 text-emerald-400 transition duration-200 group-hover:text-emerald-600"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                                            d="M7.22 14.78a.75.75 0 0 1 0-1.06L10.94 10 7.22 6.28a.75.75 0 1 1 1.06-1.06l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0Z"
                                            clip-rule="evenodd" />
                                ...
                                <a href="{{ route('hse.daftar') }}"
                                    ...
                                    <span class="flex items-center gap-3">
                                        <span
                                            class="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-100 text-emerald-600 transition duration-200 group-hover:bg-emerald-500 group-hover:text-white">
                    ...
                    <button type="submit"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.5 6.75h-6a2 2 0 0 0-2 2v6.5a2 2 0 0 0 2 2h6M12 9.75l2.75 2.75L12 15.25M14.75 12.5H5" />
                        </svg>
                        Logout
                    </button>
                </form>
        ...
        <main class="relative flex min-h-screen flex-col pt-32 sm:pt-36 lg:pt-40">
            ...
            <header class="px-8 pt-12 sm:px-12 lg:px-24">
                <div
                    class="mx-auto rounded-none border-2 border-emerald-200 bg-gradient-to-br from-white via-emerald-50/50 to-white p-10 shadow-lg">
                    <div class="space-y-4">
            ...
            <section class="relative mx-auto w-full flex-1 px-8 py-16 sm:px-12 lg:px-24">
                <div class="mx-auto max-w-4xl">
                    @if (session('success'))
                        <div
                            class="mb-6 rounded-none border-2 border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-medium text-emerald-700 shadow-sm">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    @if ($errors->any())
                        <div
                            class="mb-6 rounded-none border-2 border-red-200 bg-red-50 px-4 py-3 text-sm font-medium text-red-700 shadow-sm">
                        ...
                        <form action="{{ route('hse.store') }}" method="POST" class="space-y-8" id="hseForm">
                            ...
                            <div
                                ...
                                <div class="space-y-6">
                                    <div class="form-group">
                                        ...
                                        <div class="space-y-2">
                                            <label
                                                class="radio-option flex items-center gap-3 cursor-pointer rounded-lg border-2 border-slate-200 bg-white px-4 py-3 transition-all hover:border-emerald-300 hover:shadow-md">
                                                <input type="radio" name="kondisi_apd" value="Lengkap" required
                                                    class="h-5 w-5 text-emerald-600 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 cursor-pointer">
                                            ...
                                            <label
                                                ...
                                                <input type="radio" name="kondisi_apd" value="Tidak Lengkap" required
                                                    class="h-5 w-5 text-emerald-600 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 cursor-pointer">
                                                <span class="text-sm font-medium text-slate-700">Tidak
                                                    Lengkap</span>
                                            </label>
                                            <label
                                                class="radio-option flex items-center gap-3 cursor-pointer rounded-lg border-2 border-slate-200 bg-white px-4 py-3 transition-all hover:border-emerald-300 hover:shadow-md">
                            ...
                            <div class="flex items-center justify-end gap-4">
                                ...
                                <div class="print-format-dropdown">
                                    <button type="button" id="printFormatBtn"
                                    ...
                                    <div id="printFormatMenu" class="print-format-menu">
                                        ...
                                        <button type="button" class="print-format-item" onclick="printHSE('png')">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline mr-2"
                                                viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd"
                                                    d="M1 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H3a2 2 0 01-2-2V5zm3.293 1.293a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L7.586 10 5.293 7.707a1 1 0 010-1.414zM11 12a1 1 0 100 2h3a1 1 0 100-2h-3z"
                                                    clip-rule="evenodd" />
                                            </svg>
                                            Cetak sebagai PNG
                                        </button>
